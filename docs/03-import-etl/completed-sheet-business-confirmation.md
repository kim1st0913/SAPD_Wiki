...
2026-06-11 退役说明：旧 Sheet `信息化环境-信息化对象-安全作用域映射` 已下线归档，不再列入已完成核心 Sheet；归档记录见 `docs/05-archive/retired-sheets/2026-06-11-information-environment-scope-mapping.md`。
