...
| 主控上下文恢复 | 后续复杂任务优先读取轻量恢复入口和当前状态，不默认加载完整历史归档 | `docs/00-overview/master-context-restore.md`, `progress.md` |
...
| `progress.md` | 当前恢复入口、近期关键动作和本轮执行日志 |
| `progress-history/2026-05.md` | 2026-05 原始完整执行记录归档 |
