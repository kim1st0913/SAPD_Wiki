...
> 归档状态：`historical / full workflow before documentation governance round 4`。
...
要求：
1. 使用共享原生 Web 前端、Python 本地后端与 SQLite；
2. macOS 采用 Swift / WKWebView，Windows 采用 Electron / NSIS；
3. 建立 docs、config、data、db、src、frontend、apps、scripts、tests 等目录；
4. 创建 README 和 .gitignore；
5. 暂不实现复杂业务。
```
