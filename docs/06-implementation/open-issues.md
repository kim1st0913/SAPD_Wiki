...
- 现象：候选 Web 已形成七个独立 Tab、稳定内容版本、结构化问题 / 指标 / 威胁 / 来源和候选能力关系；`总体思路` 已以 01-000 第 1—10 章为唯一主轴，第 4 章五个核心思路可定位第 5—8 章展开。当前剩余边界不是技术身份、映射或图示逐项审核，而是其余页面职责复核、是否授权正式 freeze / apply，以及其后的 App / DMG 集成验收。
