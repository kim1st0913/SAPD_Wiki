...
async function main() {
  ...
  assert(config.capabilityDirectoryScrollOwner === ".maintenance-table-scroll" && includesAll(cssSource, ["#sourceList:has(.capability-directory-maintenance-table)", "overflow: hidden", ".maintenance-table-scroll:has(.capability-directory-maintenance-table)", "-webkit-overflow-scrolling: touch"]), "能力清单唯一滚动容器契约不完整", issues);
