...
async function main() {
  ...
  assert(includesAll(indexSource, ["p2-product-workspace.css?v=p2-product-workspace-20260726-7-action-dashboard", "P2ProductWorkspace.js?v=p2-product-workspace-20260726-7-action-dashboard", "maturity-report-v2-authoring-20260718-1", "p2-workbench-dashboard-20260716-1", "p2-dashboard-header-20260716-1", "p2-default-collapse-20260716-1", "p2-dashboard-summary-20260716-1", "p2-2-directory-navigation-20260716-3"]), "P2 V9 入口或缓存版本不完整", issues);
  ...
  if (baseUrl) {
    try {
      ...
      assert(liveIndex.includes("p2-product-workspace-20260726-7-action-dashboard") && liveIndex.includes("p2-workbench-dashboard-20260716-1") && liveIndex.includes("p2-dashboard-header-20260716-1") && liveIndex.includes("p2-2-directory-navigation-20260716-3"), "5173 未加载 P2 V9 入口", issues);
      ...
      assert(!liveCss.includes("dashboard-workbench-overview") && liveCss.includes("dashboard-workstream-lead") && liveCss.includes("dashboard-overflow-popover") && liveCss.includes("dashboard-workbench-foot") && liveCss.includes("dashboard-stat-mosaic-secondary") && liveCss.includes("dashboard-navigation-stats") && liveCss.includes("dashboard-p2-action-grid") && liveCss.includes("grid-template-columns: repeat(6, minmax(0, 1fr))") && liveCss.includes("data-dashboard-stat=\"capabilities\"") && liveCss.includes("grid-template-rows: auto minmax(0, 1fr) auto") && liveCss.includes("justify-content: flex-end"), "5173 CSS 不是 P2 V9 或缺少不规则统计 / 行动区样式", issues);
